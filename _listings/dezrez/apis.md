...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/transfers/master/_listings/dezrez/apis.md
...
- name: Dezrez.Rezi.Client.Api - Transfer funds between bank accounts (also Deposit
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/transfers/master/_listings/dezrez/apitransferinteraccount-post-openapi.md
- name: Dezrez.Rezi.Client.Api - Transfer funds between bank accounts (also Deposit
    Cash/Cheques from Cash Held)
  x-api-slug: apitransferinteraccount-post
  description: Transfer funds between bank accounts (also deposit cash/cheques from
